...
This is the basic part of the project, it performs sequence labeling using lemmas and concepts.
The main operations it does are:
1- Calculate the likelihoods (probabilities of lemmas given the concept) using the training set
2- Create the ngram file for the LM and the test file.
#### HOW-TO USE####
Do not run this script independently.
Please refer to the elaborator_l2c.sh that will creates the lexicon, runs this script and trains the automaton
...
concepts_data = []
test_data = []
#Compute the counters C(lemma,iob) and C(iob)
